  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-[1600px] flex-col justify-between gap-12">
        ...
        >
          <div>
            <p className="mb-4 inline-flex rounded-full bg-[#C9FF3D] px-4 py-2 font-sans text-[10px] uppercase tracking-[0.16em] text-[#161513]">
          ...
          <div className="rounded-[36px] bg-[#F13A18] p-5 text-[#EEE9DC] md:p-8">
            ...
            <button
              ...
              className="mt-8 flex w-full items-center justify-between rounded-full bg-[#EEE9DC] px-5 py-4 font-sans text-[10px] uppercase tracking-[0.16em] text-[#161513] transition-transform hover:-translate-y-1"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
          transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
          className="flex flex-col justify-between gap-4 border-t border-[#EEE9DC]/10 pt-6 pb-4 font-sans text-[9px] uppercase tracking-[0.18em] text-[#EEE9DC]/42 sm:flex-row"
        >
